    ...
    <main>
        ...
        <form action="" class="">
            ...
            <div v-for="(item, key) in $store.state.bagsProductData" :key="key" class="bag_goods_item bag_grid bag_padding_bottom">
                ...
                <input @click="check(item)" type="checkbox" name="product_chk" :value="item.ba_id">
                ...
                <div class="reviewC_item_grid">
                    ...
                    <div>
                        <p>총 상품가격 : {{ item.price * item.ba_count }} </p>
                    </div>
            ...
            <div class="bag_margin_top bag_btn_grid">
                <form action="">
                    ...
                    <!-- <button type="submit" class="bag_cancel bag_border_none">선택삭제</button> -->
                </form>
