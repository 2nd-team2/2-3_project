    ...
    <div class="admin">
        ...
        <form name="form" onsubmit="return false">
            <div class="admin_search">
                <input type="text" class="admin_search_text" placeholder="검색어를 입력해주세요" v-model="data.search">
                <div @click="search"><img src="/img/search.png" class="admin_search_img"></div>
            </div>
        </form>
...
import { onBeforeMount, reactive } from 'vue';
    ...
    // 검색추가
    function search() {
        store.dispatch('adminSearchUser', data);
    }
