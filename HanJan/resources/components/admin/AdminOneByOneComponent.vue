<template>
    <div class="admin">
        ...
        <div class="admin_onebyone_list_container">
            ...
            <div class="admin_onebyone_list_answer">답변 내용</div>
            <div class="admin_onebyone_list_created">작성일</div>
            <div class="admin_onebyone_list_updated">수정일</div>
            <div class="admin_onebyone_list_deleted">삭제일</div>
        </div>
